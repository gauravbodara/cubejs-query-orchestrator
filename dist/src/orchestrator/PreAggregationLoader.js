...
class PreAggregationLoader {
    ...
    prepareIndexesSql(newVersionEntry, queryOptions) {
        ...
        return this.preAggregation.indexesSql.map(({ sql, indexName }) => {
            ...
            const preAggTableToTempTableNames = this.preAggregationsTablesToTempTables;
            const resultingSql = QueryCache_1.QueryCache.replacePreAggregationTableNames(query, preAggTableToTempTableNames.concat([
    ...
    async withDropLock(lockKey, lockFn) {
