...
export type PreAggTableToTempTableNames = [string, {
...
export declare class QueryCache {
    ...
    static replacePreAggregationTableNames(queryAndParams: string | QueryWithParams, preAggregationsTablesToTempTables: PreAggTableToTempTableNames[]): string | QueryWithParams;
    /**
     ...
     */
    queryWithRetryAndRelease(query: string | QueryWithParams, values: string[], { cacheKey, dataSource, external, priority, requestId, spanId, inlineTables, useCsvQuery, lambdaTypes, persistent, aliasNameToMember, }: {
        cacheKey: CacheKey;
        dataSource: string;
        external: boolean;
        priority?: number;
    ...
    startRenewCycle(query: string | QueryWithParams, values: string[], cacheKeyQueries: (string | QueryWithParams)[], expireSecs: number, cacheKey: CacheKey, renewalThreshold: any, options: {
        requestId?: string;
    ...
    renewQuery(query: string | QueryWithParams, values: string[], cacheKeyQueries: (string | QueryWithParams)[], expireSecs: number, cacheKey: CacheKey, renewalThreshold: any, options: {
        requestId?: string;
        skipRefreshKeyWaitForRenew?: boolean;
        external?: boolean;
        dataSource: string;
    ...
    cacheQueryResult(query: string | QueryWithParams, values: string[], cacheKey: CacheKey, expiration: number, options: {
        renewalThreshold?: number;
        renewalKey?: any;
        priority?: number;
        external?: boolean;
    ...
    queryRedisKey(cacheKey: CacheKey): string;
